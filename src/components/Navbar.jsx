...
export default function Navbar({ activeSection, onNavigate, onToggleNotifications }) {
      ...
      <div className="nav-brand">
        <div className="nav-logo">
          <svg viewBox="0 0 40 40" fill="none">
            ...
            <circle cx="20" cy="20" r="6" stroke="#8fce8f" strokeWidth="1.5" fill="none"/>
            <line x1="20" y1="2" x2="20" y2="14" stroke="#8fce8f" strokeWidth="1.5"/>
            <line x1="20" y1="26" x2="20" y2="38" stroke="#8fce8f" strokeWidth="1.5"/>
            <line x1="2" y1="20" x2="14" y2="20" stroke="#8fce8f" strokeWidth="1.5"/>
            <line x1="26" y1="20" x2="38" y2="20" stroke="#8fce8f" strokeWidth="1.5"/>
            <line x1="7.4" y1="7.4" x2="15.1" y2="15.1" stroke="#8fce8f" strokeWidth="1.2"/>
            <line x1="24.9" y1="24.9" x2="32.6" y2="32.6" stroke="#8fce8f" strokeWidth="1.2"/>
            <line x1="32.6" y1="7.4" x2="24.9" y2="15.1" stroke="#8fce8f" strokeWidth="1.2"/>
            <line x1="15.1" y1="24.9" x2="7.4" y2="32.6" stroke="#8fce8f" strokeWidth="1.2"/>
          </svg>
        </div>
        <div>
